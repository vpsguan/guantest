<?php /* Smarty version 2.6.26, created on 2013-03-10 07:44:41
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
          <li><a href="#examples"><i class="icon-chevron-right"></i><?php echo $this->_tpl_vars['title']; ?>
</a></li>
      ...
      <div class="span9">
        ...
        <section id="examples">
          ...
          <ul class="thumbnails bootstrap-examples">
			<h4><?php echo $this->_tpl_vars['tid']; ?>
  <?php echo $this->_tpl_vars['time']; ?>
  作者：<?php echo $this->_tpl_vars['editer']; ?>
</h4>
