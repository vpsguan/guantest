<?php /* Smarty version 2.6.26, created on 2013-03-10 10:30:25
         compiled from back.html */ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<div class="bs-docs-social">
  <div class="container">
	...
	<li><a href="backindex.php?action=addtask">添加新闻</a></li>
	<li><a href="adddown.php">添加下载文件</a></li>
...
?>
		...
		<dd style="text-align:left;"><a href="backindex.php?action=selectone&id=<?php echo $this->_tpl_vars['s0']['id']; ?>
" style="color:#000000;"><?php echo $this->_tpl_vars['s0']['title']; ?>
</a></dd>
		<dd><a href="backindex.php?action=update&id=<?php echo $this->_tpl_vars['s0']['id']; ?>
"><img src="images/icon_edit.gif" />编辑</a></dd>
		<dd><a href="backindex.php?action=delete&id=<?php echo $this->_tpl_vars['s0']['id']; ?>
...
?>
		...
		<dd style="text-align:left;"><a href="backindex.php?action=selectone&id=<?php echo $this->_tpl_vars['s2']['id']; ?>
" style="color:#000000;"><?php echo $this->_tpl_vars['s2']['title']; ?>
</a></dd>
		<dd><a href="backindex.php?action=update&id=<?php echo $this->_tpl_vars['s2']['id']; ?>
"><img src="images/icon_edit.gif" />编辑</a></dd>
		<dd><a href="backindex.php?action=delete&id=<?php echo $this->_tpl_vars['s2']['id']; ?>
"><img src="images/icon_delete.gif" />删除</a></dd></br>
		<?php endforeach; endif; unset($_from); ?></p>
      </div>
	   <div class="span4">
...
if ($this->_foreach['st']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['s4']):
        $this->_foreach['st']['iteration']++;
?>
		<dd style="text-align:left;"><a href="backindex.php?action=selectone&id=<?php echo $this->_tpl_vars['s4']['id']; ?>
" style="color:#000000;"><?php echo $this->_tpl_vars['s4']['title']; ?>
</a></dd>
		<dd><a href="backindex.php?action=update&id=<?php echo $this->_tpl_vars['s4']['id']; ?>
"><img src="images/icon_edit.gif" />编辑</a></dd>
		<dd><a href="backindex.php?action=delete&id=<?php echo $this->_tpl_vars['s4']['id']; ?>
"><img src="images/icon_delete.gif" />删除</a></dd></br>
		<?php endforeach; endif; unset($_from); ?></p>
      </div>
  </div>
  	   <div class="span4">
	  <h2><a href="newsc.php?tid=<?php echo $this->_tpl_vars['titletype1']; ?>
"style="color:#990000;"><?php echo $this->_tpl_vars['titletype1']; ?>
</a></h2>
        <img class="marketing-img" src="assets/img/bs-docs-twitter-github.png">
        
        <p><?php $_from = $this->_tpl_vars['t1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['st'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['st']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['s1']):
        $this->_foreach['st']['iteration']++;
?>
		<dd style="text-align:left;"><a href="backindex.php?action=selectone&id=<?php echo $this->_tpl_vars['s1']['id']; ?>
" style="color:#000000;"><?php echo $this->_tpl_vars['s4']['title']; ?>
</a></dd>
		<dd><a href="backindex.php?action=update&id=<?php echo $this->_tpl_vars['s1']['id']; ?>
"><img src="images/icon_edit.gif" />编辑</a></dd>
		<dd><a href="backindex.php?action=delete&id=<?php echo $this->_tpl_vars['s1']['id']; ?>
"><img src="images/icon_delete.gif" />删除</a></dd></br>
		<?php endforeach; endif; unset($_from); ?></p>
      </div>
  </div>
...
" alt="SoundReady.fm">
			...
			<dd style="text-align:left;"><a href="backindex.php?action=selectone&id=<?php echo $this->_tpl_vars['s3']['id']; ?>
" style="color:#000000;"><?php echo $this->_tpl_vars['s4']['title']; ?>
</a></dd>
		<dd><a href="backindex.php?action=update&id=<?php echo $this->_tpl_vars['s3']['id']; ?>
"><img src="images/icon_edit.gif" />编辑</a></dd>
		<dd><a href="backindex.php?action=delete&id=<?php echo $this->_tpl_vars['s3']['id']; ?>
"><img src="images/icon_delete.gif" />删除</a></dd></br>
        </li>
	...
	<a href="backindex.php?action=addtask">添加任务</a>