...
include('smarty_init.php');	
	...
	$smarty->assign('t3',$t3);
	$smarty->assign('t4',$t4);
	$smarty->assign('dz1',"../images/b2.jpg");
	$smarty->assign('dz2',"../images/b3.jpg");
	$smarty->assign('dz3',"../images/b4.jpg");
	$smarty->assign('dz4',"../images/b5.jpg");
	$smarty->assign('dz5',"../images/b7.jpg");
	$smarty->assign('dz6',"../images/bb.jpg");
